<template>
  <div class="home-blog">
    <div class="hero" :style="{ ...bgImageStyle }">
      <div
        class="mask" ref="homeBlog" @click="changeBg()"
        :style="{
      background: `url(${$frontmatter.bgImage[Math.round(Math.random()*($frontmatter.bgImage.length-1))] ? $withBase($frontmatter.bgImage[Math.round(Math.random()*($frontmatter.bgImage.length-1))]) : require('../images/home-bg.jpg')}) center/cover no-repeat`}"></div>
      <ModuleTransition>
        <img
